...
위 박스 모양을 외워두면 됩니다. 검은 점이 루트 F이고, 흰 점들이 나머지 음입니다. 도수로 표시되어 있어서 음정 관계가 한눈에 보입니다.
...
코드가 바뀌는 마디 1박마다 위 코드톤 중 하나로 떨어뜨리려고 의식하면, 같은 펜타토닉 음형이 갑자기 훨씬 음악적으로 들립니다.

## 핵심 포인트

- F 마이너 펜타토닉의 다섯 음: **F · A♭ · B♭ · C · E♭**
- 1포지션은 1프렛부터 5프렛까지의 박스 한 개
